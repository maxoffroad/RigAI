  ...
  return `<section class="home-section vehicles-section" id="vehicles" data-figma-section="home-vehicles">
      <div class="vehicle-section-heading">
        <div>
          ...
          <p>RigAI supports multiple off-road platforms, with detailed website guides for Toyota 4Runner, third-generation Tacoma, and Jeep Wrangler JL.</p>
        </div>
      </div>
...
function guidesPreview() {
  return `<section class="home-section guides-section" id="guides" data-figma-section="home-guides">
      ...
      <p class="guides-note">Detailed guide collections now cover Toyota 4Runner, the 2016-2023 Toyota Tacoma, and the 2018-present Jeep Wrangler JL. Additional vehicle-specific guides will follow as coverage expands.</p>
    </section>`;
}
