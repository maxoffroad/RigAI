...
| `vehicle_guide_click` | A published vehicle card or vehicle-hub return link is clicked | `vehicle_slug`, `cta_location`, `page_type`, `page_path` | No | Home, vehicles directory, vehicle guides | Low | Build validator checks published card markup and stable locations |
